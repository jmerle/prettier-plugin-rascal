// This file is automatically generated by running 'yarn generate:types'
...
type AssignableNode = AssignableAnnotationNode | AssignableBracketNode | AssignableConstructorNode | AssignableFieldAccessNode | AssignableIfDefinedOrDefaultNode | AssignableSliceNode | AssignableSliceStepNode | AssignableSubscriptNode | AssignableTupleNode | AssignableVariableNode;
...
type AssignmentNode = AssignmentAdditionNode | AssignmentAppendNode | AssignmentDefaultNode | AssignmentDivisionNode | AssignmentIfDefinedNode | AssignmentIntersectionNode | AssignmentProductNode | AssignmentSubtractionNode;
...
type BasicTypeNode = BasicTypeBagNode | BasicTypeBoolNode | BasicTypeDateTimeNode | BasicTypeIntNode | BasicTypeListNode | BasicTypeListRelationNode | BasicTypeLocNode | BasicTypeMapNode | BasicTypeNodeNode | BasicTypeNumNode | BasicTypeRationalNode | BasicTypeRealNode | BasicTypeRelationNode | BasicTypeSetNode | BasicTypeStringNode | BasicTypeTupleNode | BasicTypeTypeNode | BasicTypeValueNode | BasicTypeVoidNode;
...
type ClassNode = ClassBracketNode | ClassComplementNode | ClassDifferenceNode | ClassIntersectionNode | ClassSimpleCharclassNode | ClassUnionNode;
...
type CommandNode = CommandDeclarationNode | CommandExpressionNode | CommandImportNode | CommandShellNode | CommandStatementNode;
...
type DateTimeLiteralNode = DateTimeLiteralDateAndTimeLiteralNode | DateTimeLiteralDateLiteralNode | DateTimeLiteralTimeLiteralNode;
...
type DeclarationNode = DeclarationAliasNode | DeclarationAnnotationNode | DeclarationDataNode | DeclarationDataAbstractNode | DeclarationFunctionNode | DeclarationTagNode | DeclarationVariableNode;
...
type EvalCommandNode = EvalCommandDeclarationNode | EvalCommandImportNode | EvalCommandOutputNode | EvalCommandStatementNode;
...
type ExpressionNode = ExpressionAdditionNode | ExpressionAllNode | ExpressionAndNode | ExpressionAntiNode | ExpressionAnyNode | ExpressionAppendAfterNode | ExpressionAsTypeNode | ExpressionBracketNode | ExpressionCallOrTreeNode | ExpressionClosureNode | ExpressionCompositionNode | ExpressionComprehensionNode | ExpressionConcreteNode | ExpressionDescendantNode | ExpressionDivisionNode | ExpressionEnumeratorNode | ExpressionEqualsNode | ExpressionEquivalenceNode | ExpressionFieldAccessNode | ExpressionFieldProjectNode | ExpressionFieldUpdateNode | ExpressionGetAnnotationNode | ExpressionGreaterThanNode | ExpressionGreaterThanOrEqNode | ExpressionHasNode | ExpressionIfDefinedOtherwiseNode | ExpressionIfThenElseNode | ExpressionImplicationNode | ExpressionInNode | ExpressionInsertBeforeNode | ExpressionIntersectionNode | ExpressionIsNode | ExpressionIsDefinedNode | ExpressionItNode | ExpressionJoinNode | ExpressionLessThanNode | ExpressionLessThanOrEqNode | ExpressionListNode | ExpressionLiteralNode | ExpressionMapNode | ExpressionMatchNode | ExpressionModuloNode | ExpressionMultiVariableNode | ExpressionNegationNode | ExpressionNegativeNode | ExpressionNoMatchNode | ExpressionNonEmptyBlockNode | ExpressionNonEqualsNode | ExpressionNotInNode | ExpressionOrNode | ExpressionProductNode | ExpressionQualifiedNameNode | ExpressionRangeNode | ExpressionReducerNode | ExpressionReifiedTypeNode | ExpressionReifyTypeNode | ExpressionRemainderNode | ExpressionSetNode | ExpressionSetAnnotationNode | ExpressionSliceNode | ExpressionSliceStepNode | ExpressionSpliceNode | ExpressionSplicePlusNode | ExpressionStepRangeNode | ExpressionSubscriptNode | ExpressionSubtractionNode | ExpressionTransitiveClosureNode | ExpressionTransitiveReflexiveClosureNode | ExpressionTupleNode | ExpressionTypedVariableNode | ExpressionTypedVariableBecomesNode | ExpressionVariableBecomesNode | ExpressionVisitNode | ExpressionVoidClosureNode;
...
type FunctionDeclarationNode = FunctionDeclarationAbstractNode | FunctionDeclarationConditionalNode | FunctionDeclarationDefaultNode | FunctionDeclarationExpressionNode;
...
type ImportedModuleNode = ImportedModuleActualsNode | ImportedModuleActualsRenamingNode | ImportedModuleDefaultNode | ImportedModuleRenamingsNode;
...
type IntegerLiteralNode = IntegerLiteralDecimalIntegerLiteralNode | IntegerLiteralHexIntegerLiteralNode | IntegerLiteralOctalIntegerLiteralNode;
...
type KindNode = KindAliasNode | KindAllNode | KindAnnoNode | KindDataNode | KindFunctionNode | KindModuleNode | KindTagNode | KindVariableNode | KindViewNode;
...
type LiteralNode = LiteralBooleanNode | LiteralDateTimeNode | LiteralIntegerNode | LiteralLocationNode | LiteralRationalNode | LiteralRealNode | LiteralRegExpNode | LiteralStringNode;
...
type ProdNode = ProdAllNode | ProdAssociativityGroupNode | ProdFirstNode | ProdLabeledNode | ProdReferenceNode | ProdUnlabeledNode;
...
type ShellCommandNode = ShellCommandClearNode | ShellCommandEditNode | ShellCommandHelpNode | ShellCommandHistoryNode | ShellCommandListDeclarationsNode | ShellCommandListModulesNode | ShellCommandQuitNode | ShellCommandSetOptionNode | ShellCommandTestNode | ShellCommandUndeclareNode | ShellCommandUnimportNode;
...
type StatementNode = StatementAppendNode | StatementAssertNode | StatementAssertWithMessageNode | StatementAssignmentNode | StatementBreakNode | StatementContinueNode | StatementDoWhileNode | StatementEmptyStatementNode | StatementExpressionNode | StatementFailNode | StatementFilterNode | StatementForNode | StatementFunctionDeclarationNode | StatementGlobalDirectiveNode | StatementIfThenNode | StatementIfThenElseNode | StatementInsertNode | StatementNonEmptyBlockNode | StatementReturnNode | StatementSolveNode | StatementSwitchNode | StatementThrowNode | StatementTryNode | StatementTryFinallyNode | StatementVariableDeclarationNode | StatementVisitNode | StatementWhileNode;
...
type StrategyNode = StrategyBottomUpNode | StrategyBottomUpBreakNode | StrategyInnermostNode | StrategyOutermostNode | StrategyTopDownNode | StrategyTopDownBreakNode;
...
type StringTemplateNode = StringTemplateDoWhileNode | StringTemplateForNode | StringTemplateIfThenNode | StringTemplateIfThenElseNode | StringTemplateWhileNode;
...
type SymNode = SymAlternativeNode | SymCaseInsensitiveLiteralNode | SymCharacterClassNode | SymColumnNode | SymEmptyNode | SymEndOfLineNode | SymExceptNode | SymFollowNode | SymIterNode | SymIterSepNode | SymIterStarNode | SymIterStarSepNode | SymLabeledNode | SymLiteralNode | SymNonterminalNode | SymNotFollowNode | SymNotPrecedeNode | SymOptionalNode | SymParameterNode | SymParametrizedNode | SymPrecedeNode | SymSequenceNode | SymStartNode | SymStartOfLineNode | SymUnequalNode;
...
type SyntaxDefinitionNode = SyntaxDefinitionKeywordNode | SyntaxDefinitionLanguageNode | SyntaxDefinitionLayoutNode | SyntaxDefinitionLexicalNode;
...
type TypeNode = TypeBasicNode | TypeBracketNode | TypeFunctionNode | TypeSelectorNode | TypeStructuredNode | TypeSymbolNode | TypeUserNode | TypeVariableNode;
...
type ASTNode = AssignableNode | AssignmentNode | AssocNode | BackslashNode | BasicTypeNode | BodyNode | BooleanLiteralNode | BoundNode | CaseNode | CaseInsensitiveStringConstantNode | CatchNode | CharNode | ClassNode | CommandNode | CommandsNode | CommentNode | CommonKeywordParametersNode | ComprehensionNode | ConcreteNode | ConcreteHoleNode | ConcretePartNode | DataTargetNode | DataTypeSelectorNode | DateAndTimeNode | DatePartNode | DateTimeLiteralNode | DecimalIntegerLiteralNode | DeclarationNode | DeclaratorNode | EvalCommandNode | ExpressionNode | FieldNode | FormalsNode | FunctionBodyNode | FunctionDeclarationNode | FunctionModifierNode | FunctionModifiersNode | FunctionTypeNode | HeaderNode | HexIntegerLiteralNode | ImportNode | ImportedModuleNode | IntegerLiteralNode | JustDateNode | JustTimeNode | KeywordArgument_ExpressionNode | KeywordArguments_ExpressionNode | KeywordFormalNode | KeywordFormalsNode | KindNode | LAYOUTNode | LabelNode | LiteralNode | LocalVariableDeclarationNode | LocationLiteralNode | Mapping_ExpressionNode | MidPathCharsNode | MidProtocolCharsNode | MidStringCharsNode | ModuleNode | ModuleActualsNode | ModuleParametersNode | NameNode | NamedBackslashNode | NamedRegExpNode | NonterminalNode | NonterminalLabelNode | OctalIntegerLiteralNode | OptionalCommaNode | OptionalExpressionNode | OutputNode | ParametersNode | PathCharsNode | PathPartNode | PathTailNode | PatternWithActionNode | PostPathCharsNode | PostProtocolCharsNode | PostStringCharsNode | PrePathCharsNode | PreProtocolCharsNode | PreStringCharsNode | ProdNode | ProdModifierNode | ProtocolCharsNode | ProtocolPartNode | ProtocolTailNode | QualifiedNameNode | RangeNode | RationalLiteralNode | RealLiteralNode | RegExpNode | RegExpLiteralNode | RegExpModifierNode | RenamingNode | RenamingsNode | ReplacementNode | ShellCommandNode | SignatureNode | StartNode | StatementNode | StrategyNode | StringCharacterNode | StringConstantNode | StringLiteralNode | StringMiddleNode | StringTailNode | StringTemplateNode | StructuredTypeNode | SymNode | SyntaxDefinitionNode | TagNode | TagStringNode | TagsNode | TargetNode | TimePartNoTZNode | TimeZonePartNode | ToplevelNode | TypeNode | TypeArgNode | TypeVarNode | URLCharsNode | UnicodeEscapeNode | UserTypeNode | VariableNode | VariantNode | VisibilityNode | VisitNode;
